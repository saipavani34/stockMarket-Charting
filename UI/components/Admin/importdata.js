...
class App extends Component {
  ...
  fileHandler = (event) => {    
    if(event.target.files.length){
      ...
      if(fileName.slice(fileName.lastIndexOf('.')+1) === "xlsx" || fileName.slice(fileName.lastIndexOf('.')+1) === "csv"){
        this.setState({
      ...
      <div>
        <div>
          <Jumbotron className="jumbotron-background">          
              <h1 className="display-3"><center>STOCKMARKET CHARTING</center></h1>
              <br></br>
              <br></br>
              <br></br>
              ...
              <InputGroup>
                ...
                <FormFeedback>    
                  <Fade in={this.state.isFormInvalid} tag="h6" style={{fontStyle: "italic"}}>
                    Please select a .xlsx or .csv files only !
                  </Fade>                                                                
                </FormFeedback>
              </InputGroup>     
            </Col>                                                   
